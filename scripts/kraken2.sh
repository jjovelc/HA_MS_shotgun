...
# your own one.
DB=/home/dayhoff/juan/db/kraken2_NCBI_Oct22
...
for FILE in *_R1.fq; do kraken2 --db $DB --threads 48 --use-mpa-style --memory-mapping --confidence 0.1 --report ${FILE/_R1.fq/}_mpa.tax $FILE ${FILE/_R1/_R2} --output ${FILE/_R1.fq/}.krk2; done
...
# flag '--use-mpa-style'
for FILE in *_R1.fq; do kraken2 --db $DB --threads 48 --memory-mapping --confidence 0.1 --report ${FILE/_R1.fq/}.krk2rpt --output ${FILE}.krk2 --paired ${FILE} ${FILE/_R1/_R2} --output ${FILE/_R1.fq/}.krk2; done
